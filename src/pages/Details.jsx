...
import { setGame } from '../store/actions/gamesAction'
...
export default function Details() {
  ...
  useEffect(() => {
    dispatch(setGame(`${url}/games/${id}`, opt))
  }, [])
  ...
  return (
    <React.Fragment>
         ...
         >
          <Typography variant="h4" style={{paddingLeft: 60, paddingBottom:20, color:'white'}}>
            Wondering anything from this game? Here you are..
          </Typography>
...
//         <React.Fragment>
//           <Navbar />
//           <Box display="flex" justifyContent="center" alignItems="center" className='Details'>
//             <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_ekkz8gbg.json"  background="transparent"  speed="1"  style={{width: 600, height: 600}}  loop  autoplay />
//           </Box>
//         </React.Fragment>
//       )
...
//             <Navbar />
//             <div className='Details' style={{padding:'100px 30px 10px 30px'}}>
